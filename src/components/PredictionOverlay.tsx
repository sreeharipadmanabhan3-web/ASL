...
export function PredictionOverlay({ predictions, isRecording, recordingProgress }: PredictionOverlayProps) {
      ...
      {predictions.length > 0 && !isRecording && (
        <div className="absolute bottom-4 right-4 w-72 p-4 bg-[#0a0a0a]/90 backdrop-blur-2xl border border-white/[0.08] rounded-2xl z-20 shadow-2xl animate-scale-in origin-bottom-right select-none">
          ...
          <div className="mb-4">
            ...
            <h2 className={`text-4xl font-semibold tracking-tight ${getTextColor(predictions[0].confidence)}`}>
              {predictions[0].word}
            </h2>
